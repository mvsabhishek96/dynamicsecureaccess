...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          <li class="active"><a href="d_DataMain.jsp"><span>IOT Device</span></a></li>
    ...
    <div class="content_resize">
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><strong><a href="d_DataMain.jsp">Home</a></strong></li>
            <li><strong><a href="d_Upload.jsp">Upload Data Blocks</a></strong></li>
            <li><strong><a href="d_DataLogin.jsp">Logout</a></strong></li>
          </ul>
        </div>
      </div>
      <div class="clr"></div>
