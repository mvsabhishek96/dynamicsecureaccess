...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          <li class="active"><a href="u_UserMain.jsp"><span>IOT Users</span></a></li>
    ...
    <div class="content_resize">
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><strong><a href="u_UserMain.jsp">Home</a></strong></li>
            <li><strong><a href="u_SearchFile.jsp">Search File Data</a></strong></li>
			 <li><strong><a href="u_Att_req.jsp">Request Data Access Permission</a></strong></li>
			<li><strong><a href="u_Download.jsp">Download Data</a></strong></li>
            <li><strong><a href="u_UserLogin.jsp">Logout</a></strong></li>
          </ul>
        </div>
      </div>
      <div class="clr"></div>
