...
.style2 {color: #FF0000}
.style16 {font-size: 14px; color: #FFFF00; font-weight: bold; font-style: italic; }
-->
</style>
</head>
<body>
...
<table width="478" border="0" align="center">
	<tr>
		<td width="223" bgcolor="#FF0000"><span class="style16">Enter File Name :-</span></td>
		<td width="245"><label> <input required name="t1"
			type="text"  size="40" value="<%=file%>"/> </label></td>
	</tr>
	<tr>
		<td height="34" bgcolor="#FF0000"><span class="style16">Enter Owner Name:-</span></td>
		<td><input name="oname" type="text" size="40" value="<%=oname%>" /></td>
	</tr>
	
	<tr>
		<td height="34" bgcolor="#FF0000"><span class="style16">B1-Hash 1:-</span></td>
		<td><input name="t12" type="text" size="40" value="<%=mac1%>" /></td>
	</tr>
	<tr>
		<td height="34" bgcolor="#FF0000"><span class="style16">B2-Hash 2:-</span></td>
		<td><input name="t122" type="text" size="40" value="<%=mac2%>" /></td>
	</tr>
	<tr>
		<td height="34" bgcolor="#FF0000"><span class="style16">B3-Hash 3:-</span></td>
		<td><input name="t123" type="text" size="40" value="<%=mac3%>" /></td>
	</tr>
	<tr>
		<td height="34" bgcolor="#FF0000"><span class="style16">B3-Hash 4:-</span></td>
		<td><input name="t124" type="text" size="40"value="<%=mac4%>" /></td>
	</tr>
	<tr>
		<td bgcolor="#FF0000"><span class="style16">Secret Key :-</span></td>
	...
	<tr>
		<td>
		<div align="right"><input type="submit" name="Submit" value="Decrypt & Download" /></div>		</td>
	</tr>
</table>
</form>
<%	
