...
<div class="main">
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="E_EdgenodeLogin.jsp"><span>Edge Nodes </span></a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Edgenode   Login : </span></h2>
          <p><img src="images/Fog.png" width="327" height="111" /></p>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <form action="E_EdgenodeAuthentication.jsp" method="post" id="leavereply">
            <label for="name"><br />
