...
%>
          ...
          <form action="d_UploadBlock2.jsp" method="post">
<table width="598" border="1" align="center">

	<tr>
		<td width="286" bgcolor="#FF0000"><span class="style3"><strong>File Name :- </strong></span></td>
		<td width="356"><input name="t42" type="text" id="t42" size="50"
			value="<%= file %>" readonly="readonly" /></td>
	</tr>
	<tr>
		<td width="286" bgcolor="#FF0000"><span class="style3"><strong>Block-1 </strong></span></td>
	...
	<tr>
		<td bgcolor="#FF0000"><span class="style3"><strong>Hash-1: </strong></span></td>
		<td><input name="t1" type="text" id="t4" size="50"
			value="<%= h[1] %>" readonly="readonly" /></td>
	</tr>
	<tr>
		<td width="286" bgcolor="#FF0000"><span class="style3"><strong>Block-2 </strong></span></td>
	...
	<tr>
		<td bgcolor="#FF0000"><span class="style3"><strong>Hash-2: </strong></span></td>
		<td><input name="t2" type="text" id="t4" size="50"
			value="<%= h[2] %>" readonly="readonly" /></td>
	</tr>
	<tr>
		<td width="286" bgcolor="#FF0000"><span class="style3"><strong>Block-3 </strong></span></td>
	...
	<tr>
		<td bgcolor="#FF0000"><span class="style3"><strong>Hash-3: </strong></span></td>
		<td><input name="t3" type="text" id="t4" size="50"
			value="<%= h[3]%>" readonly="readonly" /></td>
	</tr>
	<tr>
		<td width="286" bgcolor="#FF0000"><span class="style3"><strong>Block-4 </strong></span></td>
	...
	<tr>
		<td bgcolor="#FF0000"><span class="style3"><strong>Hash-4: </strong></span></td>
