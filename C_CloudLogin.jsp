    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="d_DataLogin.jsp"><span>IOT Device</span></a></li>
          <li><a href="G_GatewayLogin.jsp"><span>Edge Nodes</span></a></li>
          <li><a href="G_GatewayLogin.jsp"><span>Gateway</span></a></li>
          <li class="active"><a href="C_CloudLogin.jsp"><span>Cloud Node </span></a></li>
        </ul>
      </div>
      <div class="clr"></div>
      <div class="slider">
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="C_CloudLogin.jsp">Cloud Platform </a></li>
            <li><a href="G_GatewayLogin.jsp">Gateway</a></li>
            <li><a href="E_EdgenodeLogin.jsp">Edge Nodes</a></li>
          </ul>
        </div>
      </div>
      <div class="clr"></div>
