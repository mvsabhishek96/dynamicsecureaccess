          ...
          <div class="article">
            ...
            <table width="428" border="1.5" cellpadding="0" cellspacing="0"  align="center">
              <tr>
                ...
                <td width="101" bgcolor="#FF0000"><div align="center" class="style25">File Name </div></td>
                <td width="99" bgcolor="#FF0000"><div align="center" class="style25">Data Provider </div></td>
...
try 
	{
			...
			while ( rs.next() )
			{
              ...
              <tr>
                ...
                <td><div align="center" class="style26"><%=dt%></div></td>
                <%
