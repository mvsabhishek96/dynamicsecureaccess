...
<%
					...
					try {
						...
						while (params.hasMoreElements()) 
						{
							...
							if(paramname.equalsIgnoreCase("IOT Usersid"))
							{
						...
						//image = image.replace(".", "_b.");
			 			String query1="select * from dataprovider  where name='"+uname+"'"; 
					...
					if ( rs1.next() )
					   {
								...
								out.println("Data Provider Name Already Exits");							
							%>
							<p><a href="d_DataLogin.jsp">Back</a>         <a href="index.html">Home</a> </p>
					   ...
					   {
					   PreparedStatement ps=connection.prepareStatement("insert into dataprovider(name,pass,email,mobile,addr,dob,gender,pin,location,imagess) values(?,?,?,?,?,?,?,?,?,?)");
