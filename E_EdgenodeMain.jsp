...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
 <ul>
          <li class="active"><a href="E_EdgenodeMain.jsp"><span>Edge Nodes</span></a></li>
          <li><a href="E_EdgenodeLogin.jsp"><span>Logout</span></a></li>
        </ul>
      </div>
      <div class="clr"></div>
      <div class="slider">
    ...
    <div class="content_resize">
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><strong><a href="E_EdgenodeMain.jsp">Home</a></strong></li>
			
			<li><strong><a href="E_AttReq.jsp">View Requested Data Access Permission </a></strong></li>
            <li><strong><a href="E_EdgenodeLogin.jsp">Logout</a></strong></li>
          </ul>
        </div>
      </div>
      <div class="clr"></div>
