...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style1">Dynamic Secure Access Control and Data Sharing Through Gateway Delegation and Revocation in a Blockchain-Enabled Cloud-IoT Environment</a></h1>
      </div>
      ...
      <div class="menu_nav">
           ...
           <ul>
          <li class="active"><a href="G_GatewayMain.jsp.jsp"><span>Gateway</span></a></li>
          <li ><a href="G_GatewayLogin.jsp"><span>Logout</span></a></li>
        </ul>
      </div>
      <div class="clr"></div>
      <div class="slider">
        <div id="coin-slider"> <a href="#"><img src="images/slide1.jpg" width="960" height="360" alt="" />Dynamic Secure Access Control and Data Sharing Through Gateway Delegation and Revocation in a Blockchain-Enabled Cloud-IoT Environment</a> <a href="#"><img src="images/slide2.jpg" width="960" height="360" alt="" />Dynamic Secure Access Control and Data Sharing Through Gateway Delegation and Revocation in a Blockchain-Enabled Cloud-IoT Environment</a> <a href="#"><img src="images/slide3.jpg" width="960" height="360" alt="" />Dynamic Secure Access Control and Data Sharing Through Gateway Delegation and Revocation in a Blockchain-Enabled Cloud-IoT Environment.</a> </div>
        <div class="clr"></div>
      </div>
      <div class="clr"></div>
    </div>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu style3">
            <li><a href="G_GatewayMain.jsp">Home</a></li>
			 <li><a href="G_View_All_Revocated_Users.jsp">View All Revocated Users By Gateway</a></li>
            <li><a href="G_GatewayLogin.jsp">Logout</a></li>
          </ul>
        </div>
      </div>
      <div class="clr"></div>
