    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="u_UserLogin.jsp"><span>IOT Users</span></a></li>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p><img src="images/IOT Users.png" width="129" height="105" /></p>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <form action="u_UserAuthentication.jsp" method="post" id="leavereply">
            <label for="name"><br />
            <span class="style2">Name (required)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;              </span></label>
            <span class="style2">
            <input name="IOT Usersid" type="text" class="box" id="name" value="" />
            <label for="email"><br />
            <br />
            ...
            <p>New IOT Users ? click here to <a href="u_UserRegister.jsp"> Register</a></p>
