...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Data Providers  Details: </span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div class="article">
            <p>&nbsp;</p>
            <table width="615" border="0" cellpadding="0" cellspacing="0" align="center">
              <tr>
                ...
                <td width="124" bgcolor="#FF0000"><div align="center" class="style22">Data Provider Name </div></td>
      	...
      	try 
	{
      		...
      		String query="select * from dataprovider "; 
